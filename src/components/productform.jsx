  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-3">
      ...
      <div>
        ...
        <input name="model" type="text" placeholder="Enter product model"
         onChange={handleChange}
         value={product.model}
          className='shadow appearance-none border rounded w-full py-2 px-3'
        />
      ...
      <div>
        ...
        <input name="type" type="text" placeholder="Enter product type"
         onChange={handleChange}
         value={product.type}
          className='shadow appearance-none border rounded w-full py-2 px-3'
        />
      ...
      <div>
        ...
        <input name="capacity" type="text" placeholder="Enter capacity"
         onChange={handleChange}
      ...
      <div>
        ...
        <input name="transmission" type="text" placeholder="Enter transmission"
         onChange={handleChange}
      ...
      <div>
        ...
        <input name="price" type="text" placeholder="00.00"
         onChange={handleChange}
         value={product.price}
          className='shadow appearance-none border rounded w-full py-2 px-3'
        />
